...
let answers = function (params) {
    ...
    let opt = {
        ...
        form: {
            ...
            params: JSON.stringify({
                'url_token': params.token, 'pagesize': params.pagesize, 'offset': 0, // params.offset,
            })
        },
        method: 'POST',
        headers: {
    ...
    return request(opt).then(function (content) {
        let ret;
        try {
            ...
            if (Array.isArray(data.msg)) {
                ret = data
                    ...
                    .map(function (payload) {
                        let $ = cheerio.load(payload, {decodeEntities: false});
                        ...
                        ans.voters = voters.length
                            ? parseInt(voters.text())
                            : 0;
